...
getMovies(APIURL);
document.querySelector('#dropdown1').addEventListener("click",(el)=>{
    getMovies(SEARCHAPI + el.target.id);
})
document.querySelector('#dropdown').addEventListener("click",(el)=>{
    getMovies(SEARCHAPI + el.target.innerHTML);
})
...
// document.querySelector(".btn-default").addEventListener(onclick,()=>{
//     if (document.querySelector("#search").value != "") {
//         getMovies(SEARCHAPI + document.querySelector("#search").value)
//     } else {
//         getMovies(APIURL);
//     }    
// })
